...
extern int nrn_get_mechtype();
 ...
 "setdata_ik2", _hoc_setdata,
 "settables_ik2", _hoc_settables,
 0, 0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 4);
 	...
 	ivoc_help("help ?1 ik2 /cygdrive/c/Users/labadmin/repos/ICModel/Ik2.mod\n");
