...
def SustainedFiring_PSO(numE,numI,OUnoise,networkcheck,rndseed,drvinputsE,drvIinputs,appdtau,gppdtau,gtau,gscale,nmdavdep,mempot,biascur,Neurotransvec,ampatau1,ampatau2,nmdatau1,nmdatau2,gabatau1,gabatau2):
#    from neuron import *
#    from nrn import *
#    import numpy as np
#    import pdb
